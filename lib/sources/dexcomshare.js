...
dexcomshareSource.validate = function validate_inputs (input) {
  ...
  */
  ...
  var shareAccountName = input.shareAccountName;
  var shareAccountIsNumber = input.shareAccountIsNumber;

  var isNumber =
    shareAccountIsNumber === true ||
    String(shareAccountIsNumber).toLowerCase() === 'true';

  if (isNumber && shareAccountName && shareAccountName[0] !== '+') {
    shareAccountName = '+' + shareAccountName;
  } 
